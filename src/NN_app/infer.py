...
THRESH_LOW  = 0.7
THRESH_HIGH = 0.9
CKPT = "checkpoint_snip_standard25k.pt"
TEST_PATH = "data/processed/01_train_2025.json"  # direct path to your test_min.json
...
def load_norm(device):
    if not Path("norm_stats_standard25.pt").exists():
        print("norm_stats.pt not found -> proceeding without normalization")
        return None
    d = torch.load("norm_stats_standard25.pt", map_location="cpu")
